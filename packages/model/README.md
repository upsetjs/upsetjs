...
This is a helper package containing the data definition and model methods (like `extractSets`) for the different UpSet.js implementations.
...
[npm-image]: https://badge.fury.io/js/%40upsetjs%2Fmodel.svg
